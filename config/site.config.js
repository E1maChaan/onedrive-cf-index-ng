...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'yudaotian@elmaoncloud.onmicrosoft.com',
  ...
  email: 'mailto:admin@yudaotian.uk',
  ...
  links: [
    {
      name: 'BiliBili',
      link: 'https://space.bilibili.com/3493285326752071',
    },{
      name: 'BiliBili Live',
      link: 'https://live.bilibili.com/31997744',
    }
  ],
